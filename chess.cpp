...
bool Board::doMove()
{
    ...
    while (!stop)
    {
        ...
        cout << "Type in your move as a single four character sring. Use x-coordinates first in eash pair." << endl;
        cin >> move;
        x1 = move[0] - 48;
        y1 = move[1] - 48;
        x2 = move[2] - 48;
...
bool Board::makeMove(int x1, int y1, int x2, int y2)
{
    ...
    case EMPTY:
        ...
        break;
    default:
        std::cerr << "Something wnet wrong in the swithc statement in makeMove()" << std::endl;
        break;
    }
    return false;
}
